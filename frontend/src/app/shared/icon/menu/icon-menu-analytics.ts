...
@Component({
    moduleId: module.id,
    selector: 'icon-menu-analytics',
    template: `
        <ng-template #template>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" [ngClass]="class">
                <path
                ...
                <path
                    ...
                    stroke-linejoin="round"
                />
                <path d="M8 18V17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M12 18V12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M16 18V15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        </ng-template>
    `,
})
export class IconMenuAnalyticsComponent {
    @Input() class: any = '';
